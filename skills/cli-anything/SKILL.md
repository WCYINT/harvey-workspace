...
The repository is expected at (checked in order):

- `~/.openclaw/workspace/CLI-Anything` (user workspace)
- `/root/.openclaw/workspace/CLI-Anything` (system root)
...
```bash
python3 ~/.openclaw/workspace/skills/cli-anything/scripts/inspect_cli_anything.py
```
...
```bash
python3 ~/.openclaw/workspace/skills/cli-anything/scripts/recommend_harness.py
```

## Helpful local paths

- Repo root: `~/.openclaw/workspace/CLI-Anything`
- Plugin docs: `~/.openclaw/workspace/CLI-Anything/cli-anything-plugin`
- Example harnesses: `~/.openclaw/workspace/CLI-Anything/*/agent-harness`
